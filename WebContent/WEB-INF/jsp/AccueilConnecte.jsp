  ...
  <body>
    ...
    <section class="container main-container">
      ...
      <div class="row justify-content-end">
        <div class="col-1"><a href="#">Enchères</a></div>
        <div class="col-2"><a href="#">Vendre un article</a></div>
        <div class="col-1"><a href="#">Mon Profil</a></div>
        <div class="col-1"><a href="#">Déconnexion</a></div>
      </div>
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="row">
                        <div>
                          <input
                            type="checkbox"
                            class="mt-3"
                            id="encheres-ouvertes"
                            name="encheres-ouvertes"
                            checked
                          />
                          <label for="encheres-ouvertes"
                      ...
                      <div class="row">
                        <div>
                          <input
                            type="checkbox"
                            id="encheres-en-cours"
                            name="encheres-en-cours"
                          />
                      ...
                      <div class="row">
                        <div>
                          <input
                            type="checkbox"
                            id="encheres-remportees"
                            name="encheres-remportees"
                          />
                          <label for="encheres-remportees"
                    ...
                    <div class="col-12 col-md-6 mt-2">
                      ...
                      <div class="row">
                        <div>
                          <input
                            type="checkbox"
                            id="ventes-non-debutees"
                            name="ventes-non-debutees"
                          />
                          <label for="ventes-non-debutees"
                ...
                <div class="container bloc-objet-encheres rounded mt-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                      ...
                      <p>Vendeur : <a href="#">nomDuVendeur</a></p>
                    </div>
                  </div>
                </div>
              </div>
