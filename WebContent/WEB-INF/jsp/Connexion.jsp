        ...
        <div class="container">
          <div class="row justify-content-start bloc-text-input">
            <div class="col-sm-4 col-xs-12">
              <label for="utilisateur_identifiant" class="label"
                >Identifiant :
              </label>
            </div>
          ...
          <div class="row justify-content-start bloc-text-input">
            <div class="col-sm-4 col-xs-12">
              <label for="utilisateur_motDePasse" class="label"
                >Mot de passe :
              </label>
            </div>
            <div class="col-sm-8 col-xs-12">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-xs-4">
              ...
              <input
                ...
                checked
              />
              <label for="connexion-auto">Se souvenir de moi</label>
            </div>
          </div>
